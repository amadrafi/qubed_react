    ...
    <div  className="h-full bg-white w-full text-white p-6 border-2 border-grey-100 rounded-lg">
      ...
      <div className='grid grid-cols-1 h-80'>
        ...
        <div className='flex flex-row py-2 text-black'>
          ...
          <h1 className='my-auto font-poppins pl-3 text-xl font-semibold'>{props.engagement}% <br/><span className='font-medium text-gray-500 text-base'> engagement score</span></h1>
        </div>
      </div>
    </div>
  );
